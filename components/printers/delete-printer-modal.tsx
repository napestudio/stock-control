...
export default function DeletePrinterModal({
  isOpen,
  onClose,
  onConfirm,
  printerName,
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Confirmar Eliminación" size="sm">
      <div className="space-y-4">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-gray-900">Eliminar Impresora</h3>
            <div className="mt-2 text-sm text-gray-500">
              <p>
                ¿Está seguro de que desea eliminar la impresora{" "}
