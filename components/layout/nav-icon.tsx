...
export default function NavIcon({ name, className = "" }: NavIconProps) {
  const iconPaths = {
    ...
    cube: "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z",
    ...
    shirt: "M6 21L6 9L3 7L7 3C7 3 9 6 12 6C15 6 17 3 17 3L21 7L18 9L18 21Z",
  };
  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={2}
        d={iconPaths[name as keyof typeof iconPaths] || iconPaths.home}
      />
    </svg>
  );
}
